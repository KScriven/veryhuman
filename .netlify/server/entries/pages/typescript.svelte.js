...
var typescript_svelte_svelte_type_style_lang = "";
const css = {
...
const Typescript = (0, import_index_2dc61825.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<header><a href="${"../"}" class="${"svelte-vrkug"}"><button class="${"svelte-vrkug"}">[Home]</button></a>
	<h1 class="${"svelte-vrkug"}">Thing Two</h1></header>
